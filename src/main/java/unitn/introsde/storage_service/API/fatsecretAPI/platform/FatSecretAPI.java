...
//import unitn.introsde.lifecoach.utils.fatsecretAPI.OAuthBase;
//import unitn.introsde.lifecoach.utils.fatsecretAPI.Result;
...
public class FatSecretAPI {
	...
	// Return list with some details a bout specific name of food  
	public String foodsearch(String search_exp) throws FatSecretException, IOException{
		String urlBase = URL_BASE + "method=foods.search&search_expression="+search_exp+"&format=json";
...
//		//System.out.println(URL_BASE+result.getNormalizedRequestParameters() + "&" + OAuthBase.OAUTH_SIGNATURE + "=" + URLEncoder.encode(result.getSignature(), "utf-8"));
	...
	// Return all details a bout specific food number 
	...
	// Return list with some details a bout specific name of recipe  
	public String searchRecipe(String search_exp) throws FatSecretException, IOException{
		String urlBase = URL_BASE + "method=recipes.search&search_expression="+search_exp+"&format=json";
		////System.out.println(urlBase);
		OAuthBase oAuth = new OAuthBase();
		URL url = new URL(urlBase);
		Result result = new Result();
	...
	// Return all details a bout specific recipe number 
	public String getRecipeById(String recipe_id) throws FatSecretException, IOException{
		String urlBase = URL_BASE + "method=recipe.get&recipe_id="+recipe_id+"&format=json";
		////System.out.println(urlBase);
		OAuthBase oAuth = new OAuthBase();
		URL url = new URL(urlBase);
		Result result = new Result();
	...
	// Return all recipe types
	public String getRecipetypes() throws FatSecretException, IOException{
		String urlBase = URL_BASE + "method=recipe_types.get&format=json";
		//System.out.println(urlBase);
		OAuthBase oAuth = new OAuthBase();
		URL url = new URL(urlBase);
		Result result = new Result();
	...
	public String getExercises() throws FatSecretException, IOException{
		String urlBase = URL_BASE + "method=exercises.get&format=json";
		////System.out.println(urlBase);
		OAuthBase oAuth = new OAuthBase();
		URL url = new URL(urlBase);
		Result result = new Result();
